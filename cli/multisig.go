...
import (
	...
	typesinit "github.com/filecoin-project/go-state-types/builtin/v11/init"
	multisig2 "github.com/filecoin-project/go-state-types/builtin/v11/multisig"
...
var msigCreateCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		var execreturn typesinit.ExecReturn
...
var msigProposeCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		var retval multisig2.ProposeReturn
...
var msigLockProposeCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		params, actErr := actors.SerializeParams(&multisig2.LockBalanceParams{
...
var msigVestedCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		if cctx.Int64("end-epoch") < 0 {
			end, err = cli2.LoadTipSet(ctx, cctx, api)
			if err != nil {
				return err
			}
		} else {
...
var msigProposeThresholdCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		params, actErr := actors.SerializeParams(&multisig2.ChangeNumApprovalsThresholdParams{
			NewThreshold: newM,
		})
